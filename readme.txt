Программа запускается через терминал Linux, на устройстве должна быть загружена библиотека getch. Сразу после запуска выводится строка, которую необходимо набрать. Набор осуществляется через терминал без нажатия кнопки Enter.
